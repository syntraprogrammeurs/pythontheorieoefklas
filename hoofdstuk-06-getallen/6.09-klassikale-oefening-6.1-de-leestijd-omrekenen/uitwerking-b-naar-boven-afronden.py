...
#
# Naar boven afronden. round() rondt naar het dichtstbijzijnde getal, en dat is hier
# fout: 23,4 dagen betekent dat je op dag 24 nog leest, dus 24 dagen. De truc
# hierboven werkt, maar het kan korter:
#
